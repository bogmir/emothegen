defmodule EmothegenWeb.ErrorHelpers do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(EmothegenWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(EmothegenWeb.Gettext, "errors", msg, opts)
    end
  end
